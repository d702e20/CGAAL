...
impl AstAtl {
    ...
    pub fn convert(self) -> Phi {
        match self.kind {
            ...
            AstAtlKind::DespiteNext { players, expr } => Phi::DespiteNext { players, formula: Arc::new(expr.convert()) },
            AstAtlKind::EnforceNext { players, expr } => Phi::EnforceNext { players, formula: Arc::new(expr.convert()) },
            AstAtlKind::DespiteUntil { players, pre_expr, end_expr } => Phi::DespiteUntil { players, pre: Arc::new(pre_expr.convert()), until: Arc::new(end_expr.convert()) },
            ...
            AstAtlKind::DespiteInvariantly { players, expr } => Phi::DespiteInvariant { players, formula: Arc::new(expr.convert()) },
            AstAtlKind::EnforceInvariantly { players, expr } => Phi::EnforceInvariant { players, formula: Arc::new(expr.convert()) },
            AstAtlKind::DespiteEventually { players, expr } => Phi::DespiteEventually { players, formula: Arc::new(expr.convert()) },
            AstAtlKind::EnforceEventually { players, expr } => Phi::EnforceEventually { players, formula: Arc::new(expr.convert()) },
